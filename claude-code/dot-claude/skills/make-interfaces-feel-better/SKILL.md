...
Your design board and the design source file's brand tokens win over anything in this checklist. Use this list during the side-by-side step to name polish gaps. Fix a gap only if the board agrees; otherwise report it as a difference for the owner.
