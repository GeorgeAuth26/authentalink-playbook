...
- **Run the scorecard first.** If the sprint has a gates checklist, the new session runs `scripts/gates-check.sh` on it before anything else. The receipts say what's really done. See [gates-with-receipts.md](gates-with-receipts.md).
